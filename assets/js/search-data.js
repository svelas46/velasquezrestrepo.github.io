    ...
    handler: () => {
      window.location.href = "/al-folio/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-miyuki-mecana",
          title: 'Miyuki Mecana',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%76%65%6C%61%31%32@%6C%73%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-9072-922X", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Sara Velásquez-Restrepo", "_blank");
        },
      },{
      id: 'light-theme',
